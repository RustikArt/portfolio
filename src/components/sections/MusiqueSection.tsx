...
import { musiqueProjects, Project } from '../../data/projects';

const MusiqueSection: React.FC = () => {
  return (
    <div>
      <p className="text-lg text-center mb-8">
        Découvrez mes projets et réalisations en composition et production musicale.
      </p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {musiqueProjects.map((project: Project) => (
          <div key={project.id} className="bg-card rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all card-hover">
            ...
            <div className="p-4">
              ...
              <a 
                href={`/portfolio/musique/${project.id}`} 
