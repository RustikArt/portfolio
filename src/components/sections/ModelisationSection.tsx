...
import { modelisationProjects, Project } from '../../data/projects';

const ModelisationSection: React.FC = () => {
  return (
    <div>
      <p className="text-lg text-center mb-8">
        Découvrez mes projets et réalisations en modélisation et animation 3D.
      </p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {modelisationProjects.map((project: Project) => (
...
export default ModelisationSection;
